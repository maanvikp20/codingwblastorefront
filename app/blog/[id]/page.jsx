  ...
  if (error || !blog) return (
    <div className="min-h-screen bg-[#1a1919] flex items-center justify-center text-center">
      <div>
        ...
        <button onClick={() => router.push('/blog')} className="text-[#DC965A] underline text-sm">
          Back to blog
        </button>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-[#1a1919]">
      ...
      <div className="bg-[#242325] border-b border-white/5 px-6 py-3 flex items-center gap-2 text-sm">
        <button onClick={() => router.push('/blog')} className="text-[#DC965A] hover:underline">
          Blog
        </button>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-2 flex-wrap mb-4">
          ...
          {blog.tags?.map((tag) => (
            <span key={tag} className="bg-white/5 text-white/40 text-xs px-3 py-1 rounded-full border border-white/10">
              #{tag}
            </span>
          ))}
        </div>
        ...
        <div className="flex items-center justify-between pb-6 border-b border-white/5 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white text-sm font-semibold">{blog.author?.name ?? 'Unknown'}</p>
              {blog.publishedAt && (
        ...
        <div className="flex items-center justify-between mt-12 pt-6 border-t border-white/5">
          ...
          >
            ❤️ {liking ? '...' : likeCount} {likeCount === 1 ? 'like' : 'likes'}
          </button>
