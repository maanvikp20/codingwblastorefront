...
export default function AuthPage() {
  ...
  // Handle login from authController
  ...
  // Handle registration from authController
    ...
    <div className="min-h-screen w-screen flex overflow-hidden bg-[#1a1919]">
      ...
      <div className="hidden lg:flex lg:w-[52%] bg-[#DC965A] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="text-[#242325] font-bold text-lg tracking-tight">
            3D Print Store
          </span>
        </div>
        ...
        <div className="relative z-10">
          <h2
            className="text-[#242325] font-black leading-[1.05] mb-5"
          ...
          <p className="text-[#242325]/75 text-base leading-relaxed max-w-sm mb-10">
            Shop our in-stock prints or submit a fully custom order with your
            own design files.
          </p>
          ...
          <div className="flex flex-col gap-3">
            {FEATURES.map((f, i) => (
              <div key={i} className="flex items-center gap-3">
                ...
                <span className="text-[#242325]/80 text-sm font-medium">
                  {f}
                </span>
              </div>
            ))}
        ...
        <div className="relative z-10 flex gap-8 border-t border-[#242325]/20 pt-6">
          {[
            ...
            <div key={lbl}>
              <div className="text-[#242325] font-black text-2xl leading-none">
                {val}
              </div>
        ...
        <div className="w-full max-w-[400px]">
          ...
          {mode === "register" && (
            <div>
              ...
              <p className="text-white/40 text-sm mb-7">
                Join the community and start printing.
              </p>
